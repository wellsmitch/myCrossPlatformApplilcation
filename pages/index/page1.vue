<template name="page1">
	<view class="bg-white">
	<!-- 	<adNavBar bgColor="bg-g-red" :isRoot="true">
			<view class="midView" slot="middle">
				<view class="adIcon search"></view>
				<view class="searchView">带搜索View</view>
			</view>
		</adNavBar> -->
		<mescroll-uni :top="0" :bottom="tabBarHeight" :down="downOption" @down="downCallback" @up="upCallback">
